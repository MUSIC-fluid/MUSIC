...
class Reconst {
 ...
 public:
    ...
    ReconstCell ReconstIt_shell(double tau, TJbVec &q_vec, Cell &grid_pt, int rk_flag);

    int ReconstIt(ReconstCell &grid_p, double tau, const TJbVec &q, Cell *grid_pt,
                  int rk_flag);
    ...
    int ReconstIt_velocity_iteration(ReconstCell &grid_p, double tau,
                                     const TJbVec &q, Cell *grid_pt, int rk_flag);
