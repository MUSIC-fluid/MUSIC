...
Diss::Diss(const EOS &eosIn, const InitData &Data_in) : DATA(Data_in), eos(eosIn), transport(eosIn,Data_in), minmod(Data_in) {}
...
double Diss::Make_uWSource(double tau, Cell_small *grid_pt, Cell_small *grid_pt_prev,
    ...
    shear_to_s=transport.get_eta_over_s(T);
...
double Diss::Make_uPiSource(double tau, Cell_small *grid_pt, Cell_small *grid_pt_prev, 
    ...
    bulk = transport.get_zeta_over_s(temperature);
