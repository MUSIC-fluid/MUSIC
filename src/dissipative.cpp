        ...
        for (nu = 0; nu < 4; nu++) {
            ...
            for (direc = 1; direc <= 3; direc++) {
                if (direc == 3)
                    ...
                    taufactor = 1.0;
                /* Get_uWmns */
                Get_uWmns(tau, grid_pt, mu, nu, direc, &g, &f, &gp1, &fp1,
                          &gp2, &fp2, &gm1, &fm1, &gm2, &fm2, DATA, rk_flag);
    ...
    */
    ...
    for (nu=0; nu<4; nu++) {
        ...
        for (direc=1; direc<=3; direc++) {
            ...
            /* Get_uWmns */
            Get_uWmns(tau, grid_pt, mu, nu, direc, &g, &f, &gp1, &fp1, &gp2,
                      &fp2, &gm1, &fm1, &gm2, &fm2, DATA, rk_flag);
