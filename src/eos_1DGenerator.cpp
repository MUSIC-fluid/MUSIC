...
double EOS_1DGenerator::p_e_func(double e, double rhob, double Y_q) const {
    return (get_dpOverde3(e, rhob));
}

//! This function returns the local temperature in [1/fm]
//! input local energy density eps [1/fm^4] and rhob [1/fm^3]
double EOS_1DGenerator::get_temperature(double e, double rhob, double Y_q) const {
...
double EOS_1DGenerator::get_pressure(double e, double rhob, double Y_q) const {
    double etilde = pow(e, 0.25);
...
//! This function returns the local pressure in [1/fm^4]
//! the input local energy density [1/fm^4], rhob [1/fm^3]
void EOS_1DGenerator::get_pressure_with_gradients(
...
double EOS_1DGenerator::get_s2e(double s, double rhob, double Y_q) const {
    double e = get_s2e_finite_rhob(s, 0.0);
    return (e);
}

double EOS_1DGenerator::get_T2e(double T_in_GeV, double rhob, double Y_q) const {
