...
double EOS_UH::p_e_func(double e, double rhob, double Y_q) const {
...
double EOS_UH::get_temperature(double e, double rhob, double Y_q) const {
...
double EOS_UH::get_pressure(double e, double rhob, double Y_q) const {
    int table_idx = get_table_idx(e);
...
double EOS_UH::get_s2e(double s, double rhob, double Y_q) const {
