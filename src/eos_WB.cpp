...
double EOS_WB::get_cs2(double e, double rhob, double rhoq, double rhos) const {
    double f = calculate_velocity_of_sound_sq(e, rhob);
    return (f);
}

double EOS_WB::p_e_func(
    double e_local, double rhob, double rhoq, double rhos) const {
    double cs2_local;
    double e1 = e_local;
    double e2 = e1 * e1;
    double e3 = e2 * e1;
    ...
    double e13 = e12 * e1;
    cs2_local =
        ((5.191934309650155e-32 + 4.123605749683891e-23 * e1
...
double EOS_WB::get_temperature(
    ...
    double e11 = e10 * e1;
    temperature =
        ((1.510073201405604e-29 + 8.014062800678687e-18 * e1
...
double EOS_WB::get_pressure(
    ...
    p =
        ((1.9531729608963267e-11 * e12 + 3.1188455176941583e-7 * e11
...
double EOS_WB::get_s2e(double s, double rhob, double rhoq, double rhos) const {
