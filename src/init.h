...
class Init {
  ...
  public:
    Init(
        const EOS &eos, InitData &DATA_in,
    ...
    void initial_QS_with_zero_XY(
        int ieta, Fields &arenaFieldsPrev, Fields &arenaFieldsCurr);
    void initial_QS_with_rhob_ratios_XY(
        int ieta, Fields &arenaFieldsPrev, Fields &arenaFieldsCurr);

    void initial_AMPT_XY(
        int ieta, Fields &arenaFieldsPrev, Fields &arenaFieldsCurr);
    void initial_MCGlb_with_rhob(
        Fields &arenaFieldsPrev, Fields &arenaFieldsCurr);
    void initial_UMN_with_rhob(
        Fields &arenaFieldsPrev, Fields &arenaFieldsCurr);
