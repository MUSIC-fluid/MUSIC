...
void display_logo(int selector) {
    switch (selector) {
        ...
        case 2:  // Dancing font
            std::cout << "===================================================="
                      << std::endl;
            std::cout << "|   __  __     _   _   ____                   ____  |"
                      << std::endl;
            std::cout
                << "| U|' \\/ '|uU |\"|u| | / __\"| u      ___    U /\"___| |"
                << std::endl;
            std::cout << "| \\| |\\/| |/ \\| |\\| |<\\___ \\/      |_\"_|   "
                         "\\| | u   |"
                      << std::endl;
        ...
        case 3:  // STAR Wars
            std::cout << "====================================================="
                      << std::endl;
            std::cout << "| .___  ___.  __    __       _______. __    ______  |"
                      << std::endl;
            std::cout
                << "| |   \\/   | |  |  |  |     /       ||  |  /      | |"
                << std::endl;
...
void display_code_description_and_copyright() {
    ...
    std::cout
        << "Copyright (C) 2017  Gabriel Denicol, Charles Gale, Sangyong Jeon, "
