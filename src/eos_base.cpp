...
double EOS_base::get_entropy(
    double epsilon, double rhob, double rhoq, double rhos) const {
...
void EOS_base::getThermalVariables(
    ...
    get_pressure_with_gradients_and_cs2(
        epsilon, rhob, rhoq, rhos, p, dpde, dpdrhob, dpdrhoq, dpdrhos, cs2);
    ...
    double entropy =
        ((epsilon + p - thermalVec[7] * rhob - thermalVec[8] * rhoq
          - thermalVec[10] * rhos)
...
double EOS_base::get_dpOverdrhob2(
    double e, double rhob, double rhoq, double rhos) const {
...
double EOS_base::get_T2e_finite_rhob(
    const double T, const double rhob, double rhoq, double rhos) const {
...
//! using binary search
double EOS_base::get_s2e_finite_rhob(
...
void EOS_base::check_4D_eos() const {
    ...
    for (int i = 0; i < Ne; i++) {
        ...
        get_pressure_with_gradients_and_cs2(
            e, nb, nq, ns, p_local, dPde, dPdrhoB, dPdrhoQ, dPdrhoS, cs2);
        ...
        check_file << scientific << setw(18) << setprecision(8) << e * hbarc
                   << "   " << nb * hbarc << "   " << nq * hbarc << "   "
                   << ns * hbarc << "   " << p_local * hbarc << "   " << s_local
                   << "   " << T_local * hbarc << "   " << cs2 << "   "
                   << mu_b_local * hbarc << "   " << mu_s_local * hbarc << "   "
                   << mu_q_local * hbarc << "   " << dPde << "   "
    ...
    for (int i = 0; i < NB; i++) {
        ...
        double p_local, dPde, dPdrhoB, dPdrhoQ, dPdrhoS, cs2;
        get_pressure_with_gradients_and_cs2(
            eps, nB_local, nQ_local, nS_local, p_local, dPde, dPdrhoB, dPdrhoQ,
            dPdrhoS, cs2);
        ...
        checkFile2 << scientific << setw(18) << setprecision(8) << nB_local
                   << "   " << nQ_local << "   " << nS_local << "   "
                   << p_local * hbarc << "   " << T_local * hbarc << "   "
                   << cs2 << "   " << muB_local * hbarc << "   "
                   << muQ_local * hbarc << "   " << muS_local * hbarc << "   "
                   << dPde << "   " << dPdrhoB * hbarc << "   "
                   << dPdrhoQ * hbarc << "   " << dPdrhoS * hbarc << std::endl;
        nQ_local = 0;
        get_pressure_with_gradients_and_cs2(
            eps, nB_local, nQ_local, nS_local, p_local, dPde, dPdrhoB, dPdrhoQ,
            dPdrhoS, cs2);
        ...
        checkFile3 << scientific << setw(18) << setprecision(8) << nB_local
                   << "   " << nQ_local << "   " << nS_local << "   "
                   << p_local * hbarc << "   " << T_local * hbarc << "   "
                   << cs2 << "   " << muB_local * hbarc << "   "
                   << muQ_local * hbarc << "   " << muS_local * hbarc << "   "
