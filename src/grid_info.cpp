...
//! This function outputs hydro evolution file in binary format energy, 
//! bulk pressure and entropy
void Cell_info::OutputEvolutionDataXYEta_Bulk(SCGrid &arena, double tau) {
    const string out_name_coeff = "evolution_all_xyeta_with_Pi.dat";
    string out_open_mode;
                ...
                if (DATA.outputBinaryEvolution == 0) {
                    if (DATA.viscosity_flag == 1){
                        fprintf(out_file_coeff,
                                ...
                                e_local*hbarc, utau, ux, uy, ueta, Wtautau, 
                                Wtaux, Wtauy, Wtaueta, Wxx, Wxy, Wxeta, Wyy, 
                                Wyeta, Wyeta, bulk_Pi*hbarc, s_local*hbarc, 
                                T_local*hbarc, p_local*hbarc, cs2
                                ); // print in GeV/fm^3
                    }
                } else {
                    if (DATA.viscosity_flag == 1) {
