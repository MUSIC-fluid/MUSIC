...
static double gaulep8[] = {
    0.9602898564, 0.7966664774, 0.5255324099, 0.1834346424};
static double gaulew8[] = {
    0.1012285362, 0.2223810344, 0.3137066458, 0.3626837833};
static double gaulep10[] = {
    0.1488743389, 0.4333953941, 0.6794095682, 0.8650633666, 0.97390652};
static double gaulew10[] = {
    0.2955242247, 0.2692667193, 0.2190863625, 0.1494513491, 0.06667134};
static double gaulep12[] = {0.9815606342, 0.9041172563, 0.7699026741,
                            0.5873179542, 0.3678314989, 0.1252334085};
static double gaulew12[] = {0.0471753363, 0.1069393259, 0.1600783285,
                            0.2031674267, 0.2334925365, 0.2491470458};
...
static double gaulew20[] = {
    0.017614007139152, 0.040601429800386, 0.062672048334109, 0.083276741576704,
    0.101930119817240, 0.118194531961518, 0.131688638449176, 0.142096109318382,
    0.149172986472603, 0.152753387130725};
static double gaulep48[] = {
    0.998771007252426118601, 0.993530172266350757548, 0.984124583722826857745,
    0.970591592546247250461, 0.952987703160430860723, 0.931386690706554333114,
    0.905879136715569672822, 0.876572020274247885906, 0.843588261624393530711,
    0.807066204029442627083, 0.767159032515740339254, 0.724034130923814654674,
    0.677872379632663905212, 0.628867396776513623995, 0.577224726083972703818,
    0.523160974722233033678, 0.466902904750958404545, 0.408686481990716729916,
    0.348755886292160738160, 0.287362487355455576736, 0.224763790394689061225,
    0.161222356068891718056, 0.097004699209462698930, 0.032380170962869362033};
static double gaulew48[] = {
    0.003153346052305838633, 0.007327553901276262102, 0.011477234579234539490,
    0.015579315722943848728, 0.019616160457355527814, 0.023570760839324379141,
    0.027426509708356948200, 0.031167227832798088902, 0.034777222564770438893,
    0.038241351065830706317, 0.041545082943464749214, 0.044674560856694280419,
    0.047616658492490474826, 0.050359035553854474958, 0.052890189485193667096,
    0.055199503699984162868, 0.057277292100403215705, 0.059114839698395635746,
    0.060704439165893880053, 0.062039423159892663904, 0.063114192286254025657,
    0.063924238584648186624, 0.064466164435950082207, 0.064737696812683922503};
//! This is a class for gaussian integration
class Int {
  public:
    double gauss(
        int n, double (*f)(double, void *), double xlo, double xhi,
        void *optvec);
    ...
    double gala();   /* gala(int n, double (*func)(), double xlo,invslope,void
                      *optvec);*/
    double gahe();   /* gahe(int n, double (*func)(), double center, width,void
                      *optvec );*/
    double gauche(); /* gauche(int n,double (*func)(),double base,pole,void
                      *optvec ); */
    double gaussp();
    double galap();
    double gahep();
