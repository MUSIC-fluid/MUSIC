...
#define MAXINTV \
    2000000  // size of arry for Montecarlo numbers
...
class Freeze {
  ...
  public:
    ...
    double gauss(
        int n, double (Freeze::*f)(double, void *), double xlo, double xhi,
        void *optvec);
    ...
    double Edndp3_2bodyN(
        double y, double pt, double phi, double m1, double m2, double mr,
        int res_num);
    double Edndp3_3bodyN(
        double y, double pt, double phi, double m1, double m2, double m3,
        double mr, double norm3, int res_num);
    ...
    double get_weighted_v1(
        InitData *DATA, int number, double minpt, double maxpt, int yflag,
        double minrap, double maxrap, int ch);
    double get_weighted_psi1(
        InitData *DATA, int number, double minpt, double maxpt, int yflag,
        double minrap, double maxrap, int ch);
    ...
    void OutputDifferentialFlowNearMidrapidity(
        InitData *DATA, int number, int full);
    void OutputIntegratedFlow_vs_y(
        InitData *DATA, int number, int full, double pT_min, double pT_max);
    void Output_charged_IntegratedFlow(
