...
/* implement Kurganov-Tadmor */
 ...
 t4_file = fopen(t4_name, "w");
 fprintf(t4_file,"tau[fm], <T> plasma only [GeV], <T> plasma+mixed [GeV]\n");
 fclose(t4_file);
 FILE *t5_file;
 char* t5_name = "plasmaEvolutionTime.dat";
 t5_file = fopen(t5_name, "w");
 fprintf(t5_file,"tau_purePlasma[fm], tau_plasmaAndMixed[fm]\n");
 fclose(t5_file);
	  ...
	  for(ieta=0; ieta<maxEta; ieta+=fac)
	      ...
	      if((arena[ix][iy+fac][ieta].epsilon-epsFO)*(arena[ix][iy][ieta].epsilon-epsFO)<0.)
		{
		  ...
		  FULLSU[2]+=SIG*DTAU*DX*DETA;
	       ...
	       if((arena[ix][iy][ieta].epsilon-epsFO)*(arena[ix][iy][ieta].epsilon_prev[0]-epsFO)<0.)
		{
		  ...
		  intersect = 1;
		  intersecttau = 1;
		  tauf = tau - DTAU + DTAU * (arena[ix][iy][ieta].epsilon_prev[0]-epsFO)
		    /(arena[ix][iy][ieta].epsilon_prev[0]-arena[ix][iy][ieta].epsilon);
...
/* 	      fprintf(stderr,"before interpolation %d %d %d\n", ix, iy, ieta); */
	      ...
	      utauX1 = ((1.-xfrac)*arena[ix][iy][ieta].u_prev[0][0] + xfrac*arena[ix+fac][iy][ieta].u_prev[0][0]);
	      utauX2 = ((1.-xfrac)*arena[ix][iy+fac][ieta].u_prev[0][0] + xfrac*arena[ix+fac][iy+fac][ieta].u_prev[0][0]);
	      utauX3 = ((1.-xfrac)*arena[ix][iy][ieta+fac].u_prev[0][0] + xfrac*arena[ix+fac][iy][ieta+fac].u_prev[0][0]);
	      utauX4 = ((1.-xfrac)*arena[ix][iy+fac][ieta+fac].u_prev[0][0] + xfrac*arena[ix+fac][iy+fac][ieta+fac].u_prev[0][0]);
	      ...
	      uxX1 = ((1.-xfrac)*arena[ix][iy][ieta].u_prev[0][1] + xfrac*arena[ix+fac][iy][ieta].u_prev[0][1]);
	      uxX2 = ((1.-xfrac)*arena[ix][iy+fac][ieta].u_prev[0][1] + xfrac*arena[ix+fac][iy+fac][ieta].u_prev[0][1]);
	      uxX3 = ((1.-xfrac)*arena[ix][iy][ieta+fac].u_prev[0][1] + xfrac*arena[ix+fac][iy][ieta+fac].u_prev[0][1]);
	      uxX4 = ((1.-xfrac)*arena[ix][iy+fac][ieta+fac].u_prev[0][1] + xfrac*arena[ix+fac][iy+fac][ieta+fac].u_prev[0][1]);
	      ...
	      uyX1 = ((1.-xfrac)*arena[ix][iy][ieta].u_prev[0][2] + xfrac*arena[ix+fac][iy][ieta].u_prev[0][2]);
	      uyX2 = ((1.-xfrac)*arena[ix][iy+fac][ieta].u_prev[0][2] + xfrac*arena[ix+fac][iy+fac][ieta].u_prev[0][2]);
	      uyX3 = ((1.-xfrac)*arena[ix][iy][ieta+fac].u_prev[0][2] + xfrac*arena[ix+fac][iy][ieta+fac].u_prev[0][2]);
	      uyX4 = ((1.-xfrac)*arena[ix][iy+fac][ieta+fac].u_prev[0][2] + xfrac*arena[ix+fac][iy+fac][ieta+fac].u_prev[0][2]);
	      ...
	      uetaX1 = ((1.-xfrac)*arena[ix][iy][ieta].u_prev[0][3] + xfrac*arena[ix+fac][iy][ieta].u_prev[0][3]);
	      uetaX2 = ((1.-xfrac)*arena[ix][iy+fac][ieta].u_prev[0][3] + xfrac*arena[ix+fac][iy+fac][ieta].u_prev[0][3]);
	      uetaX3 = ((1.-xfrac)*arena[ix][iy][ieta+fac].u_prev[0][3] + xfrac*arena[ix+fac][iy][ieta+fac].u_prev[0][3]);
	      uetaX4 = ((1.-xfrac)*arena[ix][iy+fac][ieta+fac].u_prev[0][3] + xfrac*arena[ix+fac][iy+fac][ieta+fac].u_prev[0][3]);
	      uetaY1 = ((1.-yfrac)*uetaX1+yfrac*uetaX2);
	      uetaY2 = ((1.-yfrac)*uetaX3+yfrac*uetaX4);
	  ...
	  for(iy=0; iy<=ny; iy++)
	    {
	      ...
	      position = ix + (nx*iy);
	      package[position] = arena[ix][iy][0].epsilon;
	      package_prev[position] = arena[ix][iy][0].epsilon_prev[0];
	      ...
	      packageutau_prev[position] = arena[ix][iy][0].u_prev[0][0];
	      packageux_prev[position] = arena[ix][iy][0].u_prev[0][1];
	      packageuy_prev[position] = arena[ix][iy][0].u_prev[0][2];
	      packageueta_prev[position] = arena[ix][iy][0].u_prev[0][3];
	    }
	}
      MPI::COMM_WORLD.Send(package,sizeOfData,MPI::DOUBLE,to,1);
      ...
      for(iy=0; iy<=ny-fac; iy+=fac)
	{
	  ...
	  for(ieta=0; ieta<maxEta; ieta+=fac)
		...
		arena[ix+fac][iy+fac][ieta+fac].epsilon+=0.000001;
	      ...
	      if(arena[ix][iy][ieta].epsilon_prev[0]==epsFO)
		arena[ix][iy][ieta].epsilon_prev[0]+=0.000001;
	      
	      if(arena[ix+fac][iy][ieta].epsilon==epsFO)
		arena[ix+fac][iy][ieta].epsilon+=0.000001;
	      
	      if(arena[ix][iy+fac][ieta+fac].epsilon_prev[0]==epsFO)
		arena[ix][iy+fac][ieta+fac].epsilon_prev[0]+=0.000001;
	      
	      if(arena[ix][iy+fac][ieta].epsilon==epsFO)
		arena[ix][iy+fac][ieta].epsilon+=0.000001;
	      
	      if(arena[ix+fac][iy][ieta+fac].epsilon_prev[0]==epsFO)
		arena[ix+fac][iy][ieta+fac].epsilon_prev[0]+=0.000001;
	      
	      if(arena[ix][iy][ieta+fac].epsilon==epsFO)
		arena[ix][iy][ieta+fac].epsilon+=0.000001;
	      
	      if(arena[ix+fac][iy+fac][ieta].epsilon_prev[0]==epsFO)
		arena[ix+fac][iy+fac][ieta].epsilon_prev[0]+=0.000001;
	      
	      if(arena[ix+fac][iy+fac][ieta].epsilon==epsFO)
		arena[ix+fac][iy+fac][ieta].epsilon+=0.000001;
	      
	      if(arena[ix][iy][ieta+fac].epsilon_prev[0]==epsFO)
		arena[ix][iy][ieta+fac].epsilon_prev[0]+=0.000001;
	      
	      if(arena[ix+fac][iy][ieta+fac].epsilon==epsFO)
		arena[ix+fac][iy][ieta+fac].epsilon+=0.000001;
	      
	      if(arena[ix][iy+fac][ieta].epsilon_prev[0]==epsFO)
		arena[ix][iy+fac][ieta].epsilon_prev[0]+=0.000001;
	      
	      if(arena[ix][iy+fac][ieta+fac].epsilon==epsFO)
		arena[ix][iy+fac][ieta+fac].epsilon+=0.000001;
	      
	      if(arena[ix+fac][iy][ieta].epsilon_prev[0]==epsFO)
		arena[ix+fac][iy][ieta].epsilon_prev[0]+=0.000001;
	      
	      if(arena[ix][iy][ieta].epsilon==epsFO)
		arena[ix][iy][ieta].epsilon+=0.000001;
	      
	      if(arena[ix+fac][iy+fac][ieta+fac].epsilon_prev[0]==epsFO)
		arena[ix+fac][iy+fac][ieta+fac].epsilon_prev[0]+=0.000001;

	      
	      if (ieta<neta-fac)
		{
		  intersect=1;
		  if((arena[ix+fac][iy+fac][ieta+fac].epsilon-epsFO)*(arena[ix][iy][ieta].epsilon_prev[0]-epsFO)>0.)
		    if((arena[ix+fac][iy][ieta].epsilon-epsFO)*(arena[ix][iy+fac][ieta+fac].epsilon_prev[0]-epsFO)>0.)
		      if((arena[ix][iy+fac][ieta].epsilon-epsFO)*(arena[ix+fac][iy][ieta+fac].epsilon_prev[0]-epsFO)>0.)
			if((arena[ix][iy][ieta+fac].epsilon-epsFO)*(arena[ix+fac][iy+fac][ieta].epsilon_prev[0]-epsFO)>0.)
			  if((arena[ix+fac][iy+fac][ieta].epsilon-epsFO)*(arena[ix][iy][ieta+fac].epsilon_prev[0]-epsFO)>0.)
			    if((arena[ix+fac][iy][ieta+fac].epsilon-epsFO)*(arena[ix][iy+fac][ieta].epsilon_prev[0]-epsFO)>0.)
			      if((arena[ix][iy+fac][ieta+fac].epsilon-epsFO)*(arena[ix+fac][iy][ieta].epsilon_prev[0]-epsFO)>0.)
				if((arena[ix][iy][ieta].epsilon-epsFO)*(arena[ix+fac][iy+fac][ieta+fac].epsilon_prev[0]-epsFO)>0.)
				  intersect=0;
		}
	      else // if this is the right most edge
		{
		  intersect=1;
		  if((Rneighbor_eps[ix+fac][iy+fac] - epsFO)*(arena[ix][iy][ieta].epsilon_prev[0]-epsFO)>0.)
			...
			if((Rneighbor_eps[ix][iy]-epsFO)*(arena[ix+fac][iy+fac][ieta].epsilon_prev[0]-epsFO)>0.)
			  if((arena[ix+fac][iy+fac][ieta].epsilon-epsFO)*(Rneighbor_eps_prev[ix][iy]-epsFO)>0.)
			    if((Rneighbor_eps[ix+fac][iy]-epsFO)*(arena[ix][iy+fac][ieta].epsilon_prev[0]-epsFO)>0.)
			      if((Rneighbor_eps[ix][iy+fac]-epsFO)*(arena[ix+fac][iy][ieta].epsilon_prev[0]-epsFO)>0.)
	      ...
	      else		 
		{
		  ...
		  if (ieta<neta-fac)
		    {
		      cube[0]=arena[ix][iy][ieta].epsilon_prev[0];
		      cube[1]=arena[ix+fac][iy][ieta].epsilon_prev[0];
		      cube[2]=arena[ix+fac][iy+fac][ieta].epsilon_prev[0];
		      cube[3]=arena[ix][iy+fac][ieta].epsilon_prev[0];
		      ...
		      cube[8]=arena[ix][iy][ieta+fac].epsilon_prev[0];
		      cube[9]=arena[ix+fac][iy][ieta+fac].epsilon_prev[0];
		      cube[10]=arena[ix+fac][iy+fac][ieta+fac].epsilon_prev[0];
		      cube[11]=arena[ix][iy+fac][ieta+fac].epsilon_prev[0];
		  ...
		  if (tauf!=tauf)
		    {
		      ...
		      cout << (arena[ix+fac][iy+fac][ieta+fac].epsilon-epsFO)*(arena[ix][iy][ieta].epsilon_prev[0]-epsFO) << endl;
		      cout << (arena[ix+fac][iy][ieta].epsilon-epsFO)*(arena[ix][iy+fac][ieta+fac].epsilon_prev[0]-epsFO) << endl;
		      cout << (arena[ix][iy+fac][ieta].epsilon-epsFO)*(arena[ix+fac][iy][ieta+fac].epsilon_prev[0]-epsFO) << endl;
		      cout << (arena[ix][iy][ieta+fac].epsilon-epsFO)*(arena[ix+fac][iy+fac][ieta].epsilon_prev[0]-epsFO) << endl;
		      cout << (arena[ix+fac][iy+fac][ieta].epsilon-epsFO)*(arena[ix][iy][ieta+fac].epsilon_prev[0]-epsFO) << endl;
		      cout << (arena[ix+fac][iy][ieta+fac].epsilon-epsFO)*(arena[ix][iy+fac][ieta].epsilon_prev[0]-epsFO) << endl;
		      cout << (arena[ix][iy+fac][ieta+fac].epsilon-epsFO)*(arena[ix+fac][iy][ieta].epsilon_prev[0]-epsFO) << endl;
		      cout << (arena[ix][iy][ieta].epsilon-epsFO)*(arena[ix+fac][iy+fac][ieta+fac].epsilon_prev[0]-epsFO) << endl;
		      
		      cout << "epsFO=" << epsFO*hbarc << endl;
		      cout << "value=" << arena[ix+fac][iy+fac][ieta].epsilon_prev[0]*hbarc << endl;
		      cout << (arena[ix][iy][ieta+fac].epsilon-epsFO) << " " << (arena[ix+fac][iy+fac][ieta].epsilon_prev[0]-epsFO) << endl;
...
/* 			  } */
		  ...
		  if (ieta<neta-fac)
		    {
		      utauX3 = ((1.-xfrac)*arena[ix][iy][ieta+fac].u_prev[0][0] 
				+ xfrac*arena[ix+fac][iy][ieta+fac].u_prev[0][0]);
		      utauX4 = ((1.-xfrac)*arena[ix][iy+fac][ieta+fac].u_prev[0][0] 
				+ xfrac*arena[ix+fac][iy+fac][ieta+fac].u_prev[0][0]);
		    }
		  else
		    {
